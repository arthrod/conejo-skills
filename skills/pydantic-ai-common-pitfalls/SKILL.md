...
Refreshed from [`existential-birds/beagle`](https://github.com/existential-birds/beagle/blob/main/plugins/beagle-ai/skills/pydantic-ai-common-pitfalls/SKILL.md) on 2026-05-16.
Refresh with `./scripts/update-vendored.sh pydantic-ai-common-pitfalls` from the conejo-skills repo.
