---
name: plate-testing-strategy
description: Testing strategy for Plate/Slate editor work — pure unit tests, plugin contract tests, golden serializer tests. Use when planning test layers, auditing a flaky suite, or deciding what to skip.
---
...
- **Python pytest discipline — isolation, coverage, mocks** — check `testing-strategy` if appropriate.
